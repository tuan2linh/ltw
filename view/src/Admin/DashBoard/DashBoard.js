...
import { getAllUsers,getActionandInfo } from '../admin-general/services/apiService';
...
const DashBoard = (props) => {
    ...
    const [totalBadReview, setTotalBadReview] = useState(0);
        ...
        <div class="bg-white shadow-[0_4px_12px_-5px_rgba(0,0,0,0.4)] w-full max-w-sm rounded-lg overflow-hidden mx-auto font-[sans-serif] mt-4">
            ...
            <div class="p-6">
                ...
                <p class="mt-4 text-sm text-gray-500 leading-relaxed">
                    ...
                    Số đơn hàng chưa giao thành công: 2 <br />
